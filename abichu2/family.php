...
$gd=$_POST["sex"];
//insert query
$insert="INSERT INTO family(First_name,Last_name,Age,Gender) values('$fn','$ln','$ag','$gd')";
...
<p>&nbsp;</p>
<form id="form1" name="form1" method="post" action=""><u><b style="color: #0F0">
  <h1 style="text-align:center">	Fill The Family Members Information</h1></b></u></p>
  <div id="apDiv5">
    ...
    <p>
      ...
      <input name="ag" type="text" id="textfield5" size="10" placeholder="Age Here!" />
      <label> <br />
        <br />
        Gender <br />
  ...
  <p align="center" style="color:#00F"><label> <b> <br />
    ...
    <input type="submit" name="button" id="button" value="ADD NEW" onclick="return valme();" />
    <input type="reset" name="button2" id="button2" value="Clear" />
  </p>
  <div id="apDiv7" style="text-align:center"><a href="add.html"><font style="font-size:18px" color="#FFFFFF">NEXT</font></a></div>
</form>
<script type="text/javascript">
