...
{
	$idno=$_GET['ID_No'];
	$slectq="SELECT * FROM project WHERE ID_No='$idno'";
	$run_selectq=mysqli_query($conn,$slectq);
	$info=mysqli_fetch_assoc($run_selectq);
	
	$idno=$info['ID_No'];
	$fname=$info['First_name'];
	$ffname=$info['Father_name'];
	$lname=$info['Last_name'];
	$age=$info['Age'];
	$gender=$info['Gender'];
	$bplace=$info['Birth_Place'];
	$uphoto=$info['Upload_Photo'];
	$eoffice=$info['Employee_Office'];
	$jdescrpt=$info['Job_Description'];
	$phone=$info['Phone'];
	$email=$info['Email'];
	$sblock=$info['Select_Block'];
	$sflour=$info['Select_Flour'];
	$sunit=$info['Select_Unit'];
	$fmember=$info['Family_Members'];
...
$updateq="UPDATE project SET ID_No='$id',First_name='$fn',Father_name='$ff',Last_name='$ln',Age='$ag',Gender='$gd',Birth_Place='$bp',upload_photo='$pt',Employee_Office='$eo',Job_Description='$jd',Phone='$pn',Email='$em',Select_Block='$sb',Select_Flour='$sf',Select_Unit='su',Family_Members='$fm'";
...
<form id="form1" name="form1" method="post" action=""><u><b style="color:#00F">
  ...
  <div id="apDiv5">
    <p style="font-size:16px">
      ...
      <input name="sn" type="text" id="sn" size="10" placeholder="ID Here!" value="<?php echo $idno?>" />
      <label for="textfield3"><br />
        <br />
        First name</label>
      <input name="fn" type="text" id="fn" placeholder="First Name Here!" size="40" value="<?php echo $fname?>" />
    </p>
    <p style="font-size:16px">
      <label for="Sn">Father name</label>
      <input name="ff" type="text" id="ff" placeholder="Father Name Here!" size="40" value="<?php echo $ffname?>" />
    </p>
    <p style="font-size:16px"> <span id="ferr" style="color:red"> </span> <span id="nerr" style="color:red"> </span>
      ...
      <input name="ln" type="text" id="ln" placeholder="Last Name Here!" size="40" value="<?php echo $lname?>" />
      <span id="lerr" style="color:red"> </span></p>
    <p>
      <label for="textfield5">Age</label>
      <input name="ag" type="text" id="ag" size="10" placeholder="Age Here!" value="<?php echo $age?>" />
      <label> <br />
        <br />
        Gender <br />
  ...
  <div id="apDiv6">
    <p>
      ...
      <input type="text" name="bp" id="bp" placeholder="Birth Place Here!" value="<?php echo $bplace?>" />
    </p>
    <p>
    ...
    <p>Employee Office
      <input name="eo" type="text" id="textfield7" size="40" placeholder="Office Here!" value="<?php echo $eoffice?>" />
    </p>
    <p>
      <label for="textfield7">Job Description</label>
      <input name="jd" type="text" id="textfield7" size="50" placeholder="Job Here!" value="<?php echo $jdescrpt?>" />
    </p>
    <p>
      <label for="textfield9">Phone</label>
      <input type="text" name="pn" id="pn" placeholder="Phone Here!" value="<?php echo $phone?>" />
      <span id="pp" style="color:red"> </span>
      <label for="textfield11"><br />
        <br />
        Email</label>
      <input name="em" type="text" id="em" size="40" placeholder="Email Here!" value="<?php echo $email?>" />
    </p >
  </div>
  <p align="center">&nbsp;</p>
  ...
  <div id="apDiv7"><span style="font-size:16px">
    ...
    <input name="fm" type="text" id="fm" size="10" placeholder="Family No Here!" value="<?php echo $fmember?>" />
